<div class="checkout-edit-field" >
    <div class="single-tab-header">
        <h4 class="tab-title"><?php echo __('Additional Fields', 'wpfnl'); ?></h4>

        <div class="restore-btn">
            <span class="wpfnl-alert"></span>
            <button type="button" class="btn-default wpfnl_restore_btn" data-id="additional">
                <?php echo __('Restore to default', 'wpfnl'); ?>
            </button>
        </div>
        <div class="add-new-checkout-field-btn">
            <button type="button" class="btn-default custom_checkout_add_field" data-id="additional"><?php echo __('Add Field', 'wpfnl'); ?></button>
        </div>
    </div>
    <!-- /.single-tab-header -->
    ...
    <div class="checkout-edit-field-wrapper">
        ...
        <?php require WPFNL_PRO_DIR . '/admin/modules/steps/checkout/views/edit-field/checkout-single-additional-field.php';  ?>
