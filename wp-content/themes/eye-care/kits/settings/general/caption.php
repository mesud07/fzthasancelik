...
class Caption extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Caption', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default caption, Gutenberg editor.', 'eye-care' ),
		...
		foreach ( array(
			'outside' => esc_html__( 'Outside', 'eye-care' ),
			'inside' => esc_html__( 'Inside', 'eye-care' ),
		) as $key => $label ) {
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Image with Caption', 'eye-care' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			)
		);
		...
		$this->add_control(
			'image_notice',
			array(
				'raw' => esc_html__( 'Used for classic wp-caption image.', 'eye-care' ),
				'type' => Controls_Manager::RAW_HTML,
