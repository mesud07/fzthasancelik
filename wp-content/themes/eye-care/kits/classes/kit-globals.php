<?php
namespace EyeCareSpace\Kits\Classes;

use EyeCareSpace\Kits\Documents\Kit;
...
class Kit_Globals {
	...
	public static function get_global_colors_defaults() {
		return array(
			array(
				'_id' => 'primary',
				'title' => esc_html__( 'Primary', 'eye-care' ),
				'color' => Theme_Config::PRIMARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'secondary',
				'title' => esc_html__( 'Secondary', 'eye-care' ),
				'color' => Theme_Config::SECONDARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'text',
				'title' => esc_html__( 'Text', 'eye-care' ),
				'color' => Theme_Config::TEXT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'accent',
				'title' => esc_html__( 'Accent', 'eye-care' ),
				'color' => Theme_Config::ACCENT_COLOR_DEFAULT,
			),
			array(
				'_id' => 'tertiary',
				'title' => esc_html__( 'Alternate Accent', 'eye-care' ),
				'color' => Theme_Config::TERTIARY_COLOR_DEFAULT,
			),
			array(
				'_id' => 'background',
				'title' => esc_html__( 'Background', 'eye-care' ),
				'color' => Theme_Config::BACKGROUND_COLOR_DEFAULT,
			),
			array(
				'_id' => 'alternate',
				'title' => esc_html__( 'Alternate Background', 'eye-care' ),
				'color' => Theme_Config::ALTERNATE_COLOR_DEFAULT,
			),
			array(
				'_id' => 'border',
				'title' => esc_html__( 'Border', 'eye-care' ),
	...
	public static function get_global_typography_defaults() {
		...
		return array(
			...
			array(
				'_id' => 'meta',
				'title' => esc_html__( 'Meta', 'eye-care' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'taxonomy',
				'title' => esc_html__( 'Alternate Meta', 'eye-care' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'small',
				'title' => esc_html__( 'Small', 'eye-care' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'button',
				'title' => esc_html__( 'Button', 'eye-care' ),
				$typography_key => 'custom',
			...
			array(
				'_id' => 'blockquote',
				'title' => esc_html__( 'Blockquote', 'eye-care' ),
				$typography_key => 'custom',
