<?php
namespace EyeCareSpace\Woocommerce\CmsmastersFramework\Kits\Settings\Woocommerce;
...
class Woocommerce_Pages extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'WooCommerce Pages', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				'raw' => esc_html__( 'Select the pages you want to use as your default WooCommerce shop pages', 'eye-care' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Cart', 'eye-care' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'eye-care' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Checkout', 'eye-care' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'eye-care' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'My Account', 'eye-care' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'eye-care' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Terms & Conditions', 'eye-care' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'eye-care' ),
				),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Purchase Summary', 'eye-care' ),
				'type' => CmsmastersControls::QUERY,
				'select2options' => array(
					'placeholder' => esc_html__( 'Select a page', 'eye-care' ),
				),
		...
		$this->add_control(
			...
			array(
				'type' => Controls_Manager::RAW_HTML,
				'raw' => esc_html__( 'Note: Changes you make here will also be reflected in the WooCommerce settings on your WP dashboard', 'eye-care' ),
