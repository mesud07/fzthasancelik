...
class CmsForminator extends _handler.default {
  onInit() {
    ...
    this.$element.on('mousedown', '.select2', () => {
      // Use only click event
      jQuery('.select2-container').attr('data-widget-id', widgetId);
    });
  }
}
...
//# sourceMappingURL=cms-forminator.fed50d397dfd8e8a0a97.bundle.js.map