...
class Slider_Arrows extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Slider Arrows', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'options' => array(
					'always' => esc_html__( 'Always', 'eye-care' ),
					'hover' => esc_html__( 'On Hover', 'eye-care' ),
				),
				'toggle' => false,
		...
		foreach ( array(
			'prev' => esc_html__( 'Previous', 'eye-care' ),
			'next' => esc_html__( 'Next', 'eye-care' ),
		) as $key => $label ) {
			$is_prev = 'prev' === $key;
			...
			$this->add_control(
				"{$key}_icon_position",
				array(
					'label' => esc_html__( 'Icon Position', 'eye-care' ),
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'before' => esc_html__( 'Before', 'eye-care' ),
						'after' => esc_html__( 'After', 'eye-care' ),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			'text_direction',
			array(
				'label' => esc_html__( 'Text Direction', 'eye-care' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'horizontal' => esc_html__( 'Horizontal', 'eye-care' ),
					'vertical' => esc_html__( 'Vertical', 'eye-care' ),
				),
				'default' => $this->get_default_setting(
		...
		foreach ( array(
			'normal' => esc_html__( 'Normal', 'eye-care' ),
			'hover' => esc_html__( 'Hover', 'eye-care' ),
		) as $key => $label ) {
			$this->start_controls_tab(
				"states_{$key}_tab",
				array( 'label' => $label )
		...
		$this->add_responsive_control(
			'spacing',
			array(
				'label' => esc_html__( 'Arrows Spacing', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => 0,
		...
		$this->add_responsive_control(
			'box_width',
			array(
				'label' => esc_html__( 'Arrows Box Width', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'box_height',
			array(
				'label' => esc_html__( 'Arrows Box Height', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', '%' ),
				'range' => array(
					'%' => array(
		...
		$this->add_responsive_control(
			'icon_gap',
			array(
				'label' => esc_html__( 'Icon Gap', 'eye-care' ),
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Text On Tablet/Mobile', 'eye-care' ),
				'label_block' => false,
				'type' => CmsmastersControls::CHOOSE_TEXT,
				'options' => array(
					'flex' => array(
						'title' => esc_html__( 'Show', 'eye-care' ),
					),
					'none' => array(
						'title' => esc_html__( 'Hide', 'eye-care' ),
					),
				),
				'toggle' => true,
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'space-between' => array(
						'title' => esc_html__( 'Space Between', 'eye-care' ),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'options' => array(
					...
					'center' => array(
						'title' => esc_html__( 'Middle', 'eye-care' ),
