...
class Table extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Table', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			'notice',
			array(
				'raw' => esc_html__( 'Used in: default table, Gutenberg editor.', 'eye-care' ),
		...
		$parts = array(
			'tbody' => '',
			'thead' => esc_html__( 'Header', 'eye-care' ),
			'tfoot' => esc_html__( 'Footer', 'eye-care' ),
		);
