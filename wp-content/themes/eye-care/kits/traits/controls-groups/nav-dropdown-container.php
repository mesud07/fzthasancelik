	...
	protected function controls_group_nav_dropdown_container( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'First Dropdown', 'eye-care' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'center' => esc_html__( 'Below Item', 'eye-care' ),
						'stretch' => esc_html__( 'Below Header', 'eye-care' ),
					),
					'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Position', 'eye-care' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Vertical Gap', 'eye-care' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Second Dropdown', 'eye-care' ),
					'type' => Controls_Manager::HEADING,
				)
			)
		);
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Horizontal Gap', 'eye-care' ),
					'type' => Controls_Manager::SLIDER,
					'range' => array(
						'px' => array(
							'min' => -100,
