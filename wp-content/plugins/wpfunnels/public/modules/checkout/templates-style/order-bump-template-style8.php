...
<div class="wpfnl-reset wpfnl-order-bump__template-style8" style="background-color: <?php echo $orderbump_bgcolor; ?>">
    ...
    <div class="template-preview-wrapper" style="border-color: <?php echo $orderbump_color; ?>">
        ...
        <div class="template-content">
            <div class="description" style="color: <?php echo $ob_description_color ?>; --descColor8:<?php echo $ob_description_color ?>" >
