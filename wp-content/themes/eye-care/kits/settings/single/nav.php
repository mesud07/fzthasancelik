...
class Nav extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Posts Navigation', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			'nav_text_above_prev',
			array(
				'label' => esc_html__( 'Text Above Previous Post Title', 'eye-care' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Previous', 'eye-care' ),
			)
		);
		...
		$this->add_control(
			'nav_text_above_next',
			array(
				'label' => esc_html__( 'Text Above Next Post Title', 'eye-care' ),
				'label_block' => true,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
				'type' => Controls_Manager::TEXT,
				'placeholder' => esc_html__( 'Next', 'eye-care' ),
			)
		);
