    ...
    export default {
        ...
        methods: {
            onChange (event) {
				...
				}else if (event.target.value === 'bricks') {
					this.$emit('setPluginSlug', 'bricks',this.isIstallQubely)
				}else if (event.target.value === 'other') {
					this.$emit('setPluginSlug', 'other',this.isIstallQubely)
				}
            },
