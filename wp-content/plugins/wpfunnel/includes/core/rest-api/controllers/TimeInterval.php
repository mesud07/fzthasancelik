...
namespace WPFunnels\Rest\AnalyticsController;
...
class TimeInterval {
    ...
    public static function convert_local_datetime_to_gmt( $datetime_string ) {
        $datetime = new \DateTime( $datetime_string, new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
    ...
    public static function default_before() {
        $datetime = new \Wpfnl_DateTime();
        // Set local timezone or offset.
        if ( get_option( 'timezone_string' ) ) {
            $datetime->setTimezone( new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
        } else {
            $datetime->set_utc_offset( Wpfnl_functions::wpfnl_timezone_offset() );
        }
        return $datetime;
    }
    ...
    public static function next_hour_start( $datetime, $reversed = false ) {
        ...
        $hours_offset_time->setTimezone( new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
    ...
    public static function next_day_start( $datetime, $reversed = false ) {
        ...
        $next_day->setTimezone( new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
        return $next_day;
    }
    ...
    public static function next_month_start( $datetime, $reversed = false ) {
        ...
        if ( $reversed ) {
            $beg_of_month_datetime       = new \DateTime( "$year-$month-01 00:00:00", new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
            ...
            $day      = '01';
            $datetime = new \DateTime( "$year-$month-$day 00:00:00", new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
        }
    ...
    public static function next_quarter_start( $datetime, $reversed = false ) {
        ...
        $datetime = new \DateTime( "$year-$month-01 00:00:00", new \DateTimeZone( Wpfnl_functions::wpfnl_timezone_string() ) );
        if ( $reversed ) {
            $timestamp                   = (int) $datetime->format( 'U' );
            $end_of_prev_month_timestamp = $timestamp - 1;
            $datetime->setTimestamp( $end_of_prev_month_timestamp );
     ...
     * @return bool
     */
    public static function intervals_missing( $expected_interval_count, $db_records ) {
