...
<div id="step-upsell" class="wpfnl-single-step__content">
    ...
    <div class="steps-content_boxs-wrapper">
        <div class="steps-box">
            <?php
                $products = $this->step->get_internal_metas_by_key('_wpfnl_upsell_products');
                if (!$products) { ?>
            ...
            <span class="step-page-title"><?php echo __('upsell page', 'wpfnl'); ?></span>
            <?php
