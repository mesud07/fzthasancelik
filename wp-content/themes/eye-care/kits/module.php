<?php
namespace EyeCareSpace\Kits;

use EyeCareSpace\Kits\Classes;
use EyeCareSpace\Kits\Controls\Controls_Manager;
...
class Module extends ElementorBaseModule {
	...
	public function enqueue_scripts() {
		if ( ! class_exists( 'Cmsmasters_Elementor_Addon' ) ) {
			...
			wp_enqueue_script(
				'eye-care-elementor-kits-controls',
