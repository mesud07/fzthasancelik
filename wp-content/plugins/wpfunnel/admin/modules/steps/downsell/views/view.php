...
<div id="step-downsell" class="wpfnl-single-step__content">
    ...
    <div class="steps-content_boxs-wrapper">
        <div class="steps-box">
            <?php
                $products = $this->step->get_internal_metas_by_key('_wpfnl_downsell_product');
                if (!$products) { ?>
            ...
            ?>
            <?php require WPFNL_DIR . '/admin/partials/icons/upsell-icon.php'; ?>
            <span class="step-page-title"><?php echo __('downsell page', 'wpfnl'); ?></span>
            <?php
