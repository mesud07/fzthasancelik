...
class Link extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Link', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array(
				'raw' => sprintf(
					...
					__( 'Please note:', 'eye-care' ),
					__( 'The settings below will be applied to the links inside paragraphs only.', 'eye-care' )
				),
		...
		$this->add_control(
			'font_weight',
			array(
				'label' => esc_html__( 'Font Weight', 'eye-care' ),
		...
		$this->add_control(
			'font_style',
			array(
				'label' => esc_html__( 'Font Style', 'eye-care' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => esc_html__( 'Default', 'eye-care' ),
					'normal' => _x( 'Normal', 'Typography Control', 'eye-care' ),
					'italic' => _x( 'Italic', 'Typography Control', 'eye-care' ),
					'oblique' => _x( 'Oblique', 'Typography Control', 'eye-care' ),
				),
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_responsive_control(
			'letter_spacing',
			array(
				'label' => _x( 'Letter Spacing', 'Typography Control', 'eye-care' ),
		...
		$this->add_responsive_control(
			'word_spacing',
			array(
				'label' => _x( 'Word Spacing', 'Typography Control', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
				'range' => array(
					'px' => array(
						'min' => -5,
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => _x( 'None', 'Typography Control', 'eye-care' ),
					...
					'underline overline' => _x( 'Underline, Overline', 'Typography Control', 'eye-care' ),
				),
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_control(
			...
			array(
				...
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => _x( 'Solid', 'Typography Control', 'eye-care' ),
					'double' => _x( 'Double', 'Typography Control', 'eye-care' ),
					'dotted' => _x( 'Dotted', 'Typography Control', 'eye-care' ),
					'dashed' => _x( 'Dashed', 'Typography Control', 'eye-care' ),
					'wavy' => _x( 'Wavy', 'Typography Control', 'eye-care' ),
				),
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => _x( 'Thickness', 'Typography Control', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
		...
		$this->add_control(
			...
			array(
				'label' => esc_html__( 'Underline Position', 'eye-care' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'' => _x( 'Auto', 'Typography Control', 'eye-care' ),
					'under' => _x( 'Under', 'Typography Control', 'eye-care' ),
					'from-font' => _x( 'From Font', 'Typography Control', 'eye-care' ),
				),
				'dynamic' => array(),
				'selectors' => array(
		...
		$this->add_responsive_control(
			...
			array(
				'label' => _x( 'Underline Offset', 'Typography Control', 'eye-care' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => array( 'px', 'em' ),
				'range' => array(
					'px' => array(
