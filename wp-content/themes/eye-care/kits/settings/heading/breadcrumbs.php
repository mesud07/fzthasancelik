...
class Breadcrumbs extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Breadcrumbs', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		...
		$this->add_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						'in_title' => array(
							'title' => esc_html__( 'In Title', 'eye-care' ),
						),
						'new_row' => array(
							'title' => esc_html__( 'New Row', 'eye-care' ),
						),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Position of title', 'eye-care' ),
					'label_block' => false,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
					'type' => CmsmastersControls::CHOOSE_TEXT,
					'options' => array(
						'above_title' => array(
							'title' => esc_html__( 'Above', 'eye-care' ),
						),
						'below_title' => array(
							'title' => esc_html__( 'Below', 'eye-care' ),
						),
					),
					'default' => $this->get_default_setting(
		...
		$this->add_responsive_control(
			...
			array_merge_recursive(
				...
				array(
					...
					'description' => esc_html__( 'Gap between breadcrumbs and title', 'eye-care' ),
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_visibility_args,
				array(
					'label' => esc_html__( 'Visibility on Devices', 'eye-care' ),
					'label_block' => false,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
					'type' => Controls_Manager::SELECT,
					'options' => array(
						'show' => esc_html__( 'Show', 'eye-care' ),
						'hide_mobile' => esc_html__( 'Hide on mobile', 'eye-care' ),
						'hide_tablet' => esc_html__( 'Hide on tablet and mobile', 'eye-care' ),
					),
					'default' => $this->get_default_setting(
