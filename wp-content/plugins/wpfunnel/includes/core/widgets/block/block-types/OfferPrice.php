 ...
 * OrderDetails class.
 */
class OfferPrice extends AbstractDynamicBlock {
     ...
     * @var string
     */
    protected $block_name = 'offer-price';
    ...
    public function __construct( $block_name = '' )
    {
        ...
        add_action('wp_ajax_wpfnl_offer_product_price_shortcode', [$this, 'render_offer_product_shortcode']);
    }
    ...
    public function render_offer_product_shortcode() {
        ...
        $data['html'] = do_shortcode( '[wpfunnels_offer_product_price]' );
    ...
    protected function render( $attributes, $content ) {
        ...
        $output .= '<div class="wpfnl-pro-elementor-offer-product-price">';
