...
class More_Posts extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'More Posts', 'eye-care' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_control(
			...
			array(
				...
				'placeholder' => esc_html__( 'More Posts', 'eye-care' ),
			)
		);
		...
		$this->add_control(
			'more_posts_order',
			array(
				'label' => esc_html__( 'Order by', 'eye-care' ),
				'label_block' => false,
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
				'type' => Controls_Manager::SELECT,
				'options' => array(
					'recent' => esc_html__( 'Recent', 'eye-care' ),
					'category' => esc_html__( 'Related by Categories', 'eye-care' ),
					'post_tag' => esc_html__( 'Related by Tags', 'eye-care' ),
				),
				'default' => $this->get_default_setting(
		...
		$this->add_control(
			'more_posts_count',
			array(
				'label' => esc_html__( 'Count', 'eye-care' ),
				'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
