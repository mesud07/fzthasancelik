...
<?php $step_id = $_GET['step_id'];?>
<?php //include_once('add-checkout-field-drawer.php'); ?>
<?php require_once WPFNL_PRO_DIR . '/admin/modules/steps/checkout/checkout-fields/views/partials/add-checkout-field-drawer.php'; ?>
<?php require_once WPFNL_PRO_DIR . '/admin/modules/steps/checkout/checkout-fields/views/partials/edit-checkout-field-drawer.php'; ?>
<?php require_once WPFNL_PRO_DIR . '/admin/modules/steps/checkout/checkout-fields/views/partials/confirmation-alert.php'; ?>
...
<input type="hidden" id="wpfnl-cf-step-id" value="<?php echo $this->step_id ?>">
</div>
