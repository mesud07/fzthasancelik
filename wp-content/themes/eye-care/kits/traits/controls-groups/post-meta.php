	...
	protected function controls_group_post_meta( $key = '', $args = array() ) {
		...
		$this->add_control(
			...
			array_merge_recursive(
				$default_args,
				array(
					'label' => esc_html__( 'Elements', 'eye-care' ),
					'label_block' => true,
					'description' => esc_html__( 'This setting will be applied after save and reload.', 'eye-care' ),
					'type' => CmsmastersControls::SELECTIZE,
					'options' => array(
						'categories' => esc_html__( 'Categories', 'eye-care' ),
						'author' => esc_html__( 'Author', 'eye-care' ),
						'date' => esc_html__( 'Date', 'eye-care' ),
						'comments' => esc_html__( 'Comments', 'eye-care' ),
						'tags' => esc_html__( 'Tags', 'eye-care' ),
					),
					'multiple' => true,
		...
		$color_controls = array(
			'colors_text' => esc_html__( 'Text', 'eye-care' ),
			'colors_link' => esc_html__( 'Link', 'eye-care' ),
			'colors_hover' => esc_html__( 'Link Hover', 'eye-care' ),
		);
			...
			array_merge_recursive(
				...
				array(
					...
					'options' => array(
						...
						'block' => esc_html__( 'Show', 'eye-care' ),
					),
					'selectors' => array(
