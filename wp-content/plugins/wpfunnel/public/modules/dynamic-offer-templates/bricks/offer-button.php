<div >
    <div class="wpfnl-offerbtn-wrapper" id="wpfnl-offerbtn-wrapper" >
        ...
        <div class="wpfnl-offerbtn-and-price-wrapper <?php echo isset( $settings['show_product_price'] ) && $settings['show_product_price'] && isset($settings['product_price_alignment']) ? $settings['product_price_alignment'] : '' ?>">
            ...
            <a href="#" id="wpfunnels_<?php echo isset($settings['offer_button_type']) ? $settings['offer_button_type'] : ''; ?>_<?php echo isset($settings['offer_type']) ?  $settings['offer_type'] : ''; ?>" data-offertype="<?php echo isset($settings['offer_button_type']) ?  $settings['offer_button_type'] : ''; ?>" <?php echo $this->render_attributes( 'offer-button' ); ?> >
...
if( isset($settings['offer_type']) && 'accept' === $settings['offer_type'] && \WPFunnelsPro\Wpfnl_Pro_functions::maybe_unsupported_payment_gateway() ){
    /**
