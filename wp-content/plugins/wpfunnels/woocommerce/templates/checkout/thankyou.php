...
<div class="woocommerce-order">
	...
	if ( $order ) :
		...
		if(\WPFunnels\Wpfnl_functions::is_elementor_active()) {
		...
		<?php else : ?>
			...
			<ul class="woocommerce-order-overview woocommerce-thankyou-order-details order_details">
				...
				<li class="woocommerce-order-overview__total total">
					...
					<strong><?php echo apply_filters( 'wpfunnels/main_order_total_price', $order->get_formatted_order_total(), $order ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></strong>
				</li>
