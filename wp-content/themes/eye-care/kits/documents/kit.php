<?php
namespace EyeCareSpace\Kits\Documents;

use EyeCareSpace\Kits\Module as KitsModule;
...
class Kit extends BaseKit {
	...
	public function localize_settings( $settings ) {
		$settings = array_replace_recursive( $settings, array(
			'i18n' => array(
				'cmsmasters_theme' => esc_html__( 'Theme Settings', 'eye-care' ),
				'design_system' => esc_html__( 'Design System', 'eye-care' ),
				'theme_style' => esc_html__( 'Theme Style', 'eye-care' ),
				'settings' => esc_html__( 'Settings', 'eye-care' ),
				'additional_settings' => esc_html__( 'Additional Settings', 'eye-care' ),
			),
		) );
